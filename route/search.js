...
router.route('/search')
    .get(auth, (req, res) => {
        ...
        if (req.session.search_active !== undefined && req.session.search_active == "true")
        {
            res.locals.search_active = "true";
            req.session.search_active = undefined;
        }
    ...
    .post(auth, (req, res) => {
        ...
        req.session.search_active = "true";
